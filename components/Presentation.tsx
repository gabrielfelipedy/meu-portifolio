...
const Presentation = () => {
  return (
    <div className="global-padding-x bg-hero bg-cover md:bg-contain bg-no-repeat h-[800px] bg-fixed bg-mobile-position md:bg-position relative">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-white"></div>

      <div className="max-container flex flex-col z-10 relative">
        <div className="md:w-7/12">
          <h1 className="font-title mt-96 md:mt-10">Gabriel Felipe</h1>
