...
const Footer = (props: props) => {
  return (
    <footer
      id="contact"
      className={`global-padding-x global-padding-y bg-white dark:bg-dark-400 h-auto min-h-[100vh] ${props.className}`}
    >
        ...
        <div className="flex flex-col items-center">
          <div className="mt-36 w-full flex flex-col md:flex-row md:justify-evenly md:items-center">
            <div className="text-wrap break-words text-center md:text-left leading-none md:basis-6/12">
              <p className="font-title font-extrabold dark:text-white">
                VAMOS INOVAR
              </p>
              <p className="font-title text-light-500 font-extrabold">
                JUNTOS!
              </p>
            </div>
          ...
          <p className="font-subtitle font-bold text-center mt-64 text-dark-500 dark:text-light-800">
